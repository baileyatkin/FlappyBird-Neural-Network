...
void GeneticAlgorithm::UpdateGA()
{
	Sort();
	Crossover();
	Mutate();
...
void GeneticAlgorithm::Mutate(int index)
{
...
float GeneticAlgorithm::RandFrom(float min, float max)
{
...
float GeneticAlgorithm::RandInRange(float val, float range)
{
